package thirtyvirus.challenge.commands;
...
import thirtyvirus.challenge.helpers.MenuUtils;
...
public class MainPluginCommand implements CommandExecutor{
    ...
    public MainPluginCommand(ChallengePlugin main) { this.main = main; }
    ...
    private void info(CommandSender sender) {
        sender.sendMessage(ChallengePlugin.prefix + ChatColor.GRAY + "Plugin Info");
    ...
    private void help(CommandSender sender) {
        sender.sendMessage(ChallengePlugin.prefix + ChatColor.GRAY + "Commands");
        sender.sendMessage(ChatColor.DARK_PURPLE + "- " + ChatColor.GRAY + "/challenge help");
        sender.sendMessage(ChatColor.DARK_PURPLE + "- " + ChatColor.GRAY + "/challenge info");
        sender.sendMessage(ChatColor.DARK_PURPLE + "- " + ChatColor.GRAY + "/challenge tutorial");
        sender.sendMessage(ChatColor.DARK_PURPLE + "- " + ChatColor.GRAY + "/challenge reload");
        sender.sendMessage(ChatColor.DARK_PURPLE + "------------------------------");
    }
